...
import successCss from './SuccessUi.module.css'
...
export default function SuccessUi(props) {
    ...
    return (
        <div className={successCss.info}>
            <div className={successCss.info__icon}>
            ...
            <div className={successCss.info__title}>{props.content}</div>
            <div className={successCss.info__close} onClick={closeHandler}><svg height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg"><path d="m15.8333 5.34166-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z" fill="#393a37"></path></svg></div>
        </div>
    );
}